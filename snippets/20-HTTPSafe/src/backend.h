...
#include <botan/tls_client.h> // TLS::Policy
#include <botan/certstor_system.h> // Certificate_Store
#include <botan/credentials_manager.h> // Credentials_Manager

namespace HTTPSafe {
  // Credentials Manager to handle certificates
